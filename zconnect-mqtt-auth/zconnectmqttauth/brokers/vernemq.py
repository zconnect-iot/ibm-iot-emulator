...
from zconnectmqttauth.connection import get_connection
from zconnectmqttauth.auth.mongodb.util import mongo_connect
from zconnectmqttauth.client import client as mqttc
...
formatters:
    google:
        (): zconnectmqttauth.google_logging.GoogleFormatter
handlers:
    stderr:
